...
class Network_s0_late_ac3(nn.Module):
    def __init__(self, class_num, norm_layer, resnet_out=2048, feature=512, ThreeDinit=True,
        ...
        super(Network_s0_late_ac3, self).__init__()
        self.business_layer = []
    ...
    def forward(self,img, depth_mapping_3d, tsdf, sketch_gt,seg_2d):
        rgb_semantic0,rgb_semantic1,rgb_semantic2 = self.stage1(seg_2d)
        tsdf_semantic0,tsdf_semantic1, tsdf_semantic2 = self.stage2(tsdf)
