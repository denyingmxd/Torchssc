...
class Network_s_0_late_multi_supervision(nn.Module):
    def __init__(self, class_num, norm_layer, resnet_out=2048, feature=512, ThreeDinit=True,
        ...
        super(Network_s_0_late_multi_supervision, self).__init__()
        self.business_layer = []
    ...
    def forward(self,img, depth_mapping_3d, tsdf, sketch_gt,seg_2d):
        ...
        results={'pred_semantic':pred_semantic,'pred_semantic_rgb':pred_semantic_rgb,'pred_semantic_tsdf':pred_semantic_tsdf}
        return results
