...
main network2d
'''
class Network_tsdf_and_rgb_to_sketch_explicit(nn.Module):
    def __init__(self, class_num, norm_layer, resnet_out=2048, feature=512, ThreeDinit=True,
                 bn_momentum=0.1, pretrained_model=None, eval=False, freeze_bn=False):
        super(Network_tsdf_and_rgb_to_sketch_explicit, self).__init__()
        self.business_layer = []
...
if __name__ == '__main__':
    model = Network_tsdf_and_rgb_to_sketch_explicit(class_num=12, norm_layer=nn.BatchNorm3d, feature=128, eval=True)
    # print(model)
