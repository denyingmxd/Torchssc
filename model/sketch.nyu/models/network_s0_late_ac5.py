...
class Network_s0_late_ac5(nn.Module):
    def __init__(self, class_num, norm_layer, resnet_out=2048, feature=512, ThreeDinit=True,
        ...
        super(Network_s0_late_ac5, self).__init__()
        self.business_layer = []
    ...
    def forward(self,img, depth_mapping_3d, tsdf, sketch_gt,seg_2d):
        ...
        weights = self.get_voxel_weights(depth_mapping_3d)
    ...
    def get_voxel_weights(self,depth_mapping_3d):
        ...
        weight =(depth_mapping_3d<307200).reshape(depth_mapping_3d.shape[0],1,60,36,60).float()
        weights = [weight]
        for i in range(2):
