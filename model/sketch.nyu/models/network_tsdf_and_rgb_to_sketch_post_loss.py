...
class STAGE1(nn.Module):
    ...
    def forward(self, tsdf, depth_mapping_3d, feature_3d, sketch_gt=None):
        ...
        pred_sketch_now = pred_sketch_raw + feature_3d
...
class Network_tsdf_and_rgb_to_sketch_post_loss(nn.Module):
    def __init__(self, class_num, norm_layer, resnet_out=2048, feature=512, ThreeDinit=True,
                 bn_momentum=0.1, pretrained_model=None, eval=False, freeze_bn=False):
        super(Network_tsdf_and_rgb_to_sketch_post_loss, self).__init__()
        self.business_layer = []
    ...
    def forward(self, rgb, depth_mapping_3d, tsdf, sketch_gt,seg_2d=None):
...
if __name__ == '__main__':
    model = Network_tsdf_and_rgb_to_sketch_post_loss(class_num=12, norm_layer=nn.BatchNorm3d, feature=128, eval=True)
    # print(model)
