...
class STAGE2(nn.Module):
    ...
    def forward(self, segres, depth_mapping_3d, pred_sketch_raw, pred_sketch_refine):
        ...
        up_sem2 = up_sem2+sketch_proi+sketch_refine_proi
...
class Network_tsdf_and_rgb_to_sketch_late(nn.Module):
    def __init__(self, class_num, norm_layer, resnet_out=2048, feature=512, ThreeDinit=True,
                 bn_momentum=0.1, pretrained_model=None, eval=False, freeze_bn=False):
        super(Network_tsdf_and_rgb_to_sketch_late, self).__init__()
        self.business_layer = []
...
if __name__ == '__main__':
    model = Network_tsdf_and_rgb_to_sketch_late(class_num=12, norm_layer=nn.BatchNorm3d, feature=128, eval=True)
    # print(model)
