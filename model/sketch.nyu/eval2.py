...
class SegEvaluator(Evaluator):
    ...
    def compute_metric(self, results,i):
        ...
        result_line = self.print_ssc_iou(score_sc, score_ssc, raw_sketch_score, sketch_score,sketch_from_pred_score,i)
        return result_line
    ...
    def print_ssc_iou(self, sc, ssc, raw_sketch_score_sc, sketch_score_sc,sketch_from_pred_iou,i):
        lines = []
