...
parser.add_argument('--imageSize', type=int, default=64, help='the height / width of the input image to network2d')
...
for epoch in range(opt.niter):
    for i, data in enumerate(dataloader, 0):
        ############################
        # (1) Update D network2d: maximize log(D(x)) + log(1 - D(G(z)))
        ###########################
        # train with real
        netD.zero_grad()
        ...
        ############################
        # (2) Update G network2d: maximize log(D(G(z)))
        ###########################
        netG.zero_grad()
